...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    href: 'https://github.com/eric-shell',
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/ericshell',
...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white border-t border-white/10">
      <div className="max-w-[1440px] mx-auto px-6 py-16 flex items-center justify-between gap-12 flex-wrap">
