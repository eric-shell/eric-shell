  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        {/* Left: text content */}
        <CascadeGroup mountOnly className="flex flex-col gap-8">
          <CascadeItem index={0}>
            <Eyebrow className="text-white pb-2">What's up! My name is <span className="sr-only">Eric Shell.</span></Eyebrow>
          </CascadeItem>
          ...
          <CascadeItem index={2}>
            <p className="font-sans text-3xl text-white leading-relaxed pt-2">
